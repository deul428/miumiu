var image1, image2, bg_no1, bg_no2, loader, texture1, texture2, disp, dispImage;
var img_count = 8;//이미지 사용할 갯수
var img_cooking = img_count - 1;
function re_image(){
    if(image2 == undefined && image2 == null){
        bg_no1 = Math.floor(Math.random() * img_count);
    }else{
        bg_no1 = bg_no2;
    }
    do {
        bg_no2 = Math.floor(Math.random() * img_count);
    } while (bg_no2 == bg_no1);
    image1 = "img/"+bg_no1+".jpg";
    image2 = "img/"+bg_no2+".jpg";
    
    dispImage = "img/bg_shake.png";
}
